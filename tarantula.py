...
import static
import static.goliath_tarantula_static


url = modules.url.query_generator.query_generator(input(static.goliath_tarantula_static.system_input_title))
...
title = driver.title
print(static.goliath_tarantula_static.youtube_title_prefix_message, title)
...
try:
    while True:
        ...
        if modules.check.result_checker.result_checker(driver):
            print(static.goliath_tarantula_static.no_more_result_kill_task_message)
            break


except KeyboardInterrupt:
    print(static.goliath_tarantula_static.kill_task_crawling_message)
finally:
    driver.quit()